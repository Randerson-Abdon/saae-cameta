...
class boletosPHP
{
    ...
    {
        //Pegando Código do Banco obs: -não tem-
    ...
    public function getCodMoeda()
    {
        ...
        if (empty($this->codMoeda)) {
            if (!empty($this->barras)) {
                $this->codMoeda = substr($this->barras, 2, 1);
            } else if (!empty($this->ipte)) {
                $this->codMoeda = substr($this->ipte, 2, 1);
            } else {
    ...
    public function getCodVerificador()
    {
        ...
        if (empty($this->codVerificador)) {
            if (!empty($this->barras)) {
                $this->calcVerificadorBarras($this->barras);
                $this->codVerificador = substr($this->barras, 3, 1);
            } else if (!empty($this->ipte)) {
                $this->codVerificador = substr($this->ipte, 3, 1);
            } else {
    ...
    public function getDtVencimento($formato = "d/m/Y")
    {
        ...
        if (empty($this->dtVencimento)) {
            if (!empty($this->barras)) {
                $this->calcDtVencimento(substr($this->barras, 36, 8));
            } else if (!empty($this->ipte)) {
                $this->calcDtVencimento(substr($this->ipte, 45, 8));
            } else {
    ...
    {
        //Pegando fator do vencimento obs: -não tem-
        if (empty($this->fatorVencimento)) {
            if (!empty($this->barras)) {
                $this->fatorVencimento = substr($this->barras, 36, 8);
            } else if (!empty($this->ipte)) {
    ...
    public function getValorDocumento($centavos = ",", $milhar = ".")
    {
        ...
        if (empty($this->valorDocumento)) {
            if (!empty($this->barras)) {
                $this->valorDocumento = substr($this->barras, 4, 11);
            } else if (!empty($this->ipte)) {
                $this->valorDocumento = substr($this->ipte, 14, 4);
            } else {
                return "Valor do Documento não informado";
            }
        }

        $valor = substr($this->valorDocumento, 0, 9) . "." . substr($this->valorDocumento, 9, 2);
    ...
    public function getNossoNumero()
    {
        ...
        if (empty($this->nossoNumero)) {
            if (!empty($this->barras)) {
                $this->nossoNumero = substr($this->barras, 15, 4);
            } else if (!empty($this->ipte)) {
...
?>
        <div style="overflow:hidden;width:417px;height:50px;">
            <img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/p.gif" width=<?php echo $fino ?> height=<?php echo $altura ?> border=0><img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/b.gif" width=<?php echo $fino ?> height=<?php echo $altura ?> border=0><img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/p.gif" width=<?php echo $fino ?> height=<?php echo $altura ?> border=0><img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/b.gif" width=<?php echo $fino ?> height=<?php echo $altura ?> border=0><img <?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            $texto = $valor;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            if ((strlen($texto) % 2) <> 0) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                $texto = "0" . $texto;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ?> src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/p.gif" width=<?php echo $f1 ?> height=<?php echo $altura ?> border=0><img <?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    if (substr($f, $i, 1) == "0") {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $f2 = $fino;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $f2 = $largo;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ?> src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/b.gif" width=<?php echo $f2 ?> height=<?php echo $altura ?> border=0><img <?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            }

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            // Draw guarda final
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ?> src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/p.gif" width=<?php echo $largo ?> height=<?php echo $altura ?> border=0><img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/b.gif" width=<?php echo $fino ?> height=<?php echo $altura ?> border=0><img src="http://www.saaesantaizabel.com.br/lib/boleto/lib/img/p.gif" width=<?php echo 1 ?> height=<?php echo $altura ?> border=0>
        </div>
<?php
    } //Fim da fun��o
