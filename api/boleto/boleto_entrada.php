...
//echo $id_acordo_parcelamento . ', ' . $doc . ', ' . $total_geral_faturado2 . ', ' . $data2 . ', ' . $linha_count2 . ', ' . $linha_count . ', ' . $vencimento2 . ', ' . $id_usuario_editor_registro;
...
$dadosboleto["demonstrativo2"] = "Entrada referente ao acordo Nº " . $id_acordo_parcelamento . " firmado em " . date("d/m/Y");
