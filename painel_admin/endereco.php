                    ...
                    <div class="table-responsive">
                      ...
                      <?php 
                        ...
                        if(isset($_GET['buttonPesquisar']) and ($_GET['txtpesquisarEndereco'] != '') and ($_GET['txtpesquisarEndereco2'] != '') and ($_GET['txtpesquisarEndereco3'] != '')){
                          ...
                          $query = "SELECT * from endereco_instalacao where id_localidade LIKE '$nome' and id_bairro = '$bairro' and id_logradouro = '$log' order by id_unidade_consumidora asc ";

                          $result_count = mysqli_query($conexao, $query);
                          

                        }else{
                          $query = "SELECT * from endereco_instalacao order by id_unidade_consumidora desc limit 10";

                          $query_count = "SELECT * from endereco_instalacao";
                              ...
                              <table class="table">
                                ...
                                <?php
                                  while($res = mysqli_fetch_array($result)){
                                    ...
                                    $query_loc = "SELECT * from localidade where id_localidade = ' $localidade' ";
