      ...
      <div id="uc" name="uc" style="display: none;">
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <select class="form-control" id="localidade" name="localidade">
              ...
              ?>
                ...
                <option value="<?php echo $res['id_localidade'] ?>"><?php echo $res['id_localidade'] ?>-<?php echo $res['nome_localidade'] ?></option>
          ...
          <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" minlength="2" name="id_unidade_consumidora" placeholder="UC" required>
          </div>

          <div class="form-group col-md-3">
            <label for="fornecedor">Status</label>
            <select class="form-control" id="slStatus3" name="slStatus3" style="text-transform:uppercase;">
          ...
          <div class="form-group col-md-2">
            <label for="id_produto">Buscar</label>
            <button type="button" class="btn btn-success form-control" id="buscar3"><i class="fas fa-search"></i></button>
          </div>
