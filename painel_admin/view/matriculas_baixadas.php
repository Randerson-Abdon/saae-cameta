...
<div class="container">
  ...
  <h4 class="title">Consulta de Matrículas Baixadas</h4>
  ...
  <form action="" method="POST" target="_blank">
    ...
    <div class="row">
      ...
      <div class="form-group col-lg-3 col-md-6 col-sm-12">
        <label for="fornecedor">Matrícula</label>
        <input type="text" class="form-control mr-2" placeholder="Digite a matrícula aqui" id="id_unidade_consumidora" name="id_unidade_consumidora" />
      </div>
    ...
    <div class="row">
      ...
      <div class="form-group col-lg-2 col-md-4 col-sm-12">
        ...
        <button type="button" class="btn btn-info form-control" id="buscar2" onclick="javascript:submitForm(this.form, 'model/processa_matriculas_baixadas.php',);"><i class="fas fa-clipboard-list"></i></button>
      </div>
