...
@$mes_faturado2 = $_GET['mes_faturado2'];

$mes_faturado1 = str_pad($mes_faturado1, 2, '0', STR_PAD_LEFT);
@$mes = $mes_faturado1 . $mes_faturado2;
...
<form method="" action="">
  <div class="row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control mr-2" name="id_unidade_consumidora" value="<?php echo $id_unidade_consumidora; ?>" placeholder="Matrícula" required>
    </div>

    <div class="form-group col-md-3">
      <label for="id_produto">Competência</label>
      <input type="text" class="form-control mr-2" id="mes" name="mes_faturado" placeholder=" Mês Faturado" value="<?php echo $mes; ?>" required>
    </div>
...
<?php
    ...
    if (isset($_POST['editar'])) {
      ...
      if ($result == '' && $result_bpa == '' && $result_acordo == '') {
        ...
        echo "<script language='javascript'>window.location='admin.php?acao=faturamento'; </script>";
      }
    }
  }
}
