...
<body>
	...
	if ($id_acordo_firmado == '' and $id == $id_unidade_consumidora) { ?>
												...
												?>
													...
													<tr>
														...
														<td>
															...
															<a class="text-primary" title="Ver Perfil" href="admin.php?acao=baixa&func=perfil&id=<?php echo $uc; ?>&id_localidade=<?php echo $id_localidade; ?>"><i class="fas fa-id-card"></i>&nbsp;&nbsp;</a>

															<a class="text-success" title="Iniciar Baixa" href="admin.php?acao=baixa&func=baixa&id=<?php echo $uc; ?>&mes_faturado=<?php echo $rData; ?>&id_localidade=<?php echo $id_localidade; ?>"> <i class="fas fa-play"></i></a>
														</td>
													</tr>
													</tr>
