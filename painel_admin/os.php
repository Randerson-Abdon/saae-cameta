              ...
              <div class="row">
                ...
                <div class="table-responsive ml-3 mr-3">
                  ...
                  <div class="form-group col-md-5">
                      ...
                      <label for="id_produto"><?php if($status_requerimento == 'A'){ echo 'EM ANÁLISE'; 
                      }elseif($status_requerimento == 'D'){ echo 'DEFERIDO';
                      }else{ echo 'INDEFERIDO'; 
                      } ?></label>
                  </div>
          ...
          <h5 class="modal-title">Outros</h5>
              ...
              <div class="row">                 
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control mr-2" maxlength="10" id="saida" name="data_inicio_servico" value="2020-06-01"/>
                  </div>

                  <div class="form-group col-md-2">
                    <label for="fornecedor">Hora de Inicio</label>
                    <input type="time" class="form-control mr-2" id="appt" name="hora_inicio_servico" min="07:00" max="16:00" required>
                  </div>
         ...
         <!-- Modal content-->
          ...
          <h5 class="modal-title">Outros</h5>
              ...
              <div class="row">                 
                  ...
                  <div class="form-group col-md-9">
                    <label for="fornecedor">Observações</label>
                      <input type="text" maxlength="255" class="form-control mr-2" name="observacoes" value="<?php echo $observacoes; ?>" style="text-transform:uppercase;">
                  </div>
...
<?php 
              ...
              <div class="row">
                ...
                <div class="table-responsive ml-3 mr-3">
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <label for="id_produto"><?php if($status_ordem_servico == '1'){ echo 'EM ANÁLISE'; 
                      }elseif($status_ordem_servico == '2'){ echo 'EM ANDAMENTO';
                      }elseif($status_ordem_servico == '3'){ echo 'CONCLUÍDO';
                      }else{ echo 'INVIÁVEL'; 
                      } ?></label>
                  </div>
 ...
 <script> $("#modalIniciar").modal("show"); </script> 
 <script> $("#modalFinalizar").modal("show"); </script>
 <script> $("#modalVer").modal("show"); </script>
