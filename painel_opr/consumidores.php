...
<div class="container ml-4">
  ...
  <div class="content">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-sm" title="Ver Consumidor" href="operacional.php?acao=consumidores&func=editar&id=<?php echo $id; ?>&id_localidade=<?php echo $id_localidade; ?>"><i class="fas fa-user-friends"></i></a>

                          <a class="btn btn-info btn-sm" title="Ver Endereçamento" href="operacional.php?acao=consumidores&func=edita2&id=<?php echo $id; ?>&id_localidade=<?php echo $id_localidade; ?>"><i class="fas fa-list-alt"></i></a>
    ...
    <?php if (@$_GET['func'] == 'ativa') {
      ...
      echo "<script language='javascript'>window.location='operacional.php?acao=consumidores'; </script>";
    } ?>
