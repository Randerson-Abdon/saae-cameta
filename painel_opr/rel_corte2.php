                ...
                <div class="table-responsive">
                  <form action="rel_corte.php" method="POST" target="_blank">
                    <table style="margin-bottom: 15px;">
                      <thead>
                        <tr>
                          <th style="width: 20%;"><img height="110%" width="90%" src="../img/parametros/<?php echo $logo_orgao; ?>" alt=""></th>
                          <th>
                    ...
                    <table class="table table-sm table-hover" style="font-size: 10pt;">
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <td>
                            <span class="text-muted">Registros: <?php echo $row; ?> </span>
                          </td>

                          <td>
                            <span class="text-muted">Total Geral: <?php echo $total_final; ?> </span>
                          </td>
                        </tr>
