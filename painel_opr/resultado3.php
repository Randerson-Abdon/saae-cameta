...
<section>
	  ...
	  <div class="content">
			  ...
			  <div class="card-body">
				...
				<?php 
					while($sqlline = mysqli_fetch_array($query)){
						...
						<a class="text-primary" title="Ver Perfil"href="operacional.php?acao=requerimento&func=perfil&id=<?php echo $uc; ?>" ><i class="fas fa-id-card"></i></a>

						<a class="text-secondary" title="Criar Requerimento" href="operacional.php?acao=requerimento&func=criar&id=<?php echo $uc; ?>" ><i class="fas fa-plus-square"></i></a>
						</td>
						</tr>
						</tr>
		...
		<p class="danger">Nao foram encontrados registros com esses parametros!</p>
