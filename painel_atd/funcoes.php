                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table">
                        ...
                        ?>
                            ...
                            <a class="btn btn-info" href="atendimento.php?acao=funcoes&func=edita&id=<?php echo $id; ?>"><i class="fas fa-edit"></i></a>

                             <a class="btn btn-danger" href="atendimento.php?acao=funcoes&func=excluir&id=<?php echo $id; ?>"><i class="fa fa-minus-square"></i></a>
  ...
  if(isset($_POST['salvar'])){
   ...
   // }
    ...
    if($result == ''){
      ...
      echo "<script language='javascript'>window.location='atendimento.php?acao=funcoes'; </script>";
