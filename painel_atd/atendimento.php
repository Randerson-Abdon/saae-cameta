    ...
    <nav id="sidebar" class="sidebar-wrapper bg-dark">
      <div class="sidebar-content">
        <div class="sidebar-brand">
          <a href="atendimento.php">Painel do Atendente</a>
          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="atendimento.php?acao=consumidores">Consumidor</a>
                  </li>
                  <li>
                    <a href="atendimento.php?acao=requerimento">Requerimentos</a>
                    </a>
                  </li>
                  <li>
                    <a href="atendimento.php?acao=faturamento">Histórico Financeiro</a>
                  </li>
                  <li>
                    <a href="atendimento.php?acao=acordos">Controle de Acordos</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="atendimento.php?acao=localidades">Localidades</a>
                    </a>
                  </li>
                  <li>
                    <a href="atendimento.php?acao=bairros">Bairros</a>
                  </li>
                  <li>
                    <a href="atendimento.php?acao=logradouros">Logradouros</a>
                  </li>
                </ul>
              </div>
            </li>
