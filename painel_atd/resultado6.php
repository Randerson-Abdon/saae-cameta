            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                ?>
                  ...
                  <form action="atendimento.php?acao=fatura" method="POST" target="_blank">
        ...
        <div class="container ml-4">
          ...
          <div class="content">
            ...
            <div class="modal-footer" style="margin-left: -25px; width: 100%;">
              ...
              <button type="button" class="btn btn-success mb-3" onclick="window.location.href = 'atendimento.php?acao=acordos'">Mais Detalhes </button>
