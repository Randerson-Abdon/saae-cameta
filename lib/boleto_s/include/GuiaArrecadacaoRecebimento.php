...
class GuiaArrecadacaoRecebimento {
    ...
    function __construct($identificacao_do_produto, $identificacao_do_segmento, $identificacao_do_valor_referente,
                $valor_referente, $identificacao_da_empresa_orgao, $mes_fatura, $id_boleto, $matricula, $data_vencimento){
        ...
        $this->campo_livre_utilizacao_empresa = $mes_fatura.$id_boleto.$matricula.date("Ymd", strtotime($data_vencimento)); // padrão DDMMAAAA
    }
