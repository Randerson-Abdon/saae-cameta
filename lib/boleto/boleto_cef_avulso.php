...
foreach ($fatura as $mes_fat) {
	...
	$query_up = "UPDATE historico_financeiro SET id_boleto_avulso = '$doc' where id_unidade_consumidora = '$id' AND mes_faturado = '$mes_fat' AND data_pagamento_fatura is null AND id_acordo_parcelamento is null AND status_estorno_tarifa = 'N' ";
