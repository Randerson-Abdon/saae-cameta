...
//trazendo info parametros
$query_ps = "SELECT * from parametros_saae";
$result_ps = mysqli_query($conexao, $query_ps);
$row_ps = mysqli_fetch_array($result_ps);
$febraban = $row_ps['febraban'];
...
$linha = new GuiaArrecadacaoRecebimento(8, 2, 6, "$valor", "$febraban", "$data", "$tipo_boleto$id_localidade", "$id", "$dt_vencimento");
