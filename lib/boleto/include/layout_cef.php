...
<HEAD>
  ...
  <style type=text/css>
    <!--.cp { font: bold 10px Arial; color: black} <!--.ti { font: 9px Arial, Helvetica, sans-serif} <!--.ld { font: bold 15px Arial; color: #000000} <!--.ct { FONT: 9px "Arial Narrow" ; COLOR: #000033} <!--.cn { FONT: 9px Arial; COLOR: black } <!--.bc { font: bold 20px Arial; color: #000000 } <!--.ld2 { font: bold 12px Arial; color: #000000 } 
    -->
  </style>
</head>
...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
  ...
  <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
    <tr>
      <td width=150><IMG width="100%" SRC="../../img/parametros/<?php echo $dadosboleto["logo_orgao"]; ?>" alt="Logo"></td>
  ...
  <table cellspacing=0 cellpadding=0 width=666 border=0>
    <tr>
      <td class=cp width=150>
        <span class="campo"><IMG src="../../img/parametros/logo01.jpeg" width="150" height="50" border=0></span>
      </td>
      <td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td>
      <td class=cpt width=58 valign=bottom></td>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
    <tbody>
      ...
      <tr>
        <td class=cp valign=top width=7 height=12><img height=23 src=imagens/1.png width=1 border=0></td>
  ...
  <table cellspacing=0 cellpadding=0 border=0>
    <tbody>
      <tr>
        ...
        <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td>
        <td class=ct valign=top width=180 height=13>Céd.
          baixa</td>
      </tr>
      <tr>
        <td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td>
