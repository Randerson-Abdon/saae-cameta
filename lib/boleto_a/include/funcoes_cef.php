...
$mesFatura = str_replace('/', '', $mesFatura);
...
$linha = new GuiaArrecadacaoRecebimento(8, 2, 6, "$valor", "0565", "$mesFatura", "$tipo_boleto$id_localidade", "$id", "$dt_vencimento");

//conversão de linha digitavel
$dados = $linha->setNumeroDocumento("")->get();

$_SESSION['codigo_barras'] = $linha->setNumeroDocumento("")->get();
