    ...
    <nav id="sidebar" class="sidebar-wrapper bg-dark">
      <div class="sidebar-content">
        <div class="sidebar-brand">
          <a href="caixa.php">Painel do Caixa</a>
          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="caixa.php?acao=in">Abertura</a>
                  </li>
                  <li>
                    <a target="_blank" href="operacao.php">Operação</a>
                  </li>
                  <li>
                    <a href="caixa.php?acao=out">Fechamento</a>
                  </li>
                  <li>
                    <a href="caixa.php?acao=movimento">Movimento de Caixa</a>
                  </li>
                </ul>
              </div>
            </li>
