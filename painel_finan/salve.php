...
while ($row = mysqli_fetch_assoc($result_cp)) {
    ...
    if ($ta1 == '4') {
        ...
        $query_ba = "SELECT * FROM boleto_avulso WHERE id_localidade = '$localidade' AND id_unidade_consumidora = '$id_unidade_consumidora' AND total_geral_faturado = '$total_pagamento_fatura' ";
        ...
        $query_up = "UPDATE historico_financeiro SET data_pagamento_fatura = '$data', id_banco_arrecadador = '$id_banco_arrecadador', id_sequencial_bancario = '$id_sequencial_documento', id_usuario_editor_registro = '$id_usuario_editor' where id_conta_avulsa = '$id_boleto_avulso' ";

        $result_up = mysqli_query($conexao, $query_up);
    } elseif ($ta1 == '0') {
        // BAIXANDO ACORDOS
        $query_up = "UPDATE acordo_parcelamento SET data_pagamento_parcela = '$data', id_usuario_editor_registro = '$id_usuario_editor' where id_unidade_consumidora = '$id_unidade_consumidora' AND valor_parcela = '$total_pagamento_fatura' AND data_vencimento_parcela = '$data_vencimento_fatura' AND id_localidade = '$localidade' ";
        ...
        $query = "UPDATE historico_financeiro SET data_pagamento_fatura = '$data', total_pagamento_fatura = '$total_pagamento_fatura', id_banco_arrecadador = '$id_banco_arrecadador', id_sequencial_bancario = '$id_sequencial_documento', id_usuario_editor_registro = '$id_usuario_editor' where id_unidade_consumidora = '$id_unidade_consumidora' AND mes_faturado = '$mes_fatura_arrecadada' ";
...
if ($result_movimento == '') {
    ...
    $query_up = "UPDATE cx_termo_abertura_encerramento SET total_entradas = '$valor_novo' WHERE id_termo_abertura_encerramento = '$id_termo_abertura_encerramento' AND id_operador = '$id_usuario_editor' ";
    $result_up = mysqli_query($conexao, $query_up);
