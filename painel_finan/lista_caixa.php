...
<body>
	...
	$query_cp = "SELECT * from cx_caixa_permanente where id_unidade_consumidora = '$uc' and mes_fatura_arrecadada = '$mes_fatura_arrecadada' and tipo_arrecadacao = '$tipo_arrecadacao' and valor_total_arrecadacao = '$valor_total_arrecadacao' ";
