...
<body>
  ...
  <div class="container ml-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                @$nome  = $_GET['nome2'];
                @$status  = $_GET['status2'];
                @$id_usuario_editor = $_GET['usuario'];
                //recuperando dados da tabela NOME USER
                $query = "SELECT * from usuario_sistema where id_usuario = '$id_usuario_editor' order by id_usuario asc";
                $result = mysqli_query($conexao, $query);
                $res_nome = mysqli_fetch_array($result);
                $nome_usuario = $res_nome['nome_usuario'];
                        ...
                        <th>
                          <p style="margin-top: 15px; text-transform:uppercase;"><?php echo $nome_prefeitura ?> <br>
                            ...
                            RELATÓRIO DE MOVIMENTO <?php if ($status == 'T') {
                                                    ...
                                                    } ?> ‐ <?php echo date('d/m/Y',  strtotime($nome)); ?> <br>
                            OPERADOR(A) <?php echo $nome_usuario; ?></p>
    ...
    ?>
      ...
      <table class="table table-borderless" style="font-size: 10pt; width: 97%;">
        ...
        <tbody>
          ...
          while ($res = mysqli_fetch_array($result)) {
            ...
            $qty += $res["valor_entrada"];
            $valor_entrada_soma = 'R$ ' . number_format($qty, 2, ".", "");

            $qty1 += $res["valor_saida"];
            $valor_saida_soma = 'R$ ' . number_format($qty1, 2, ".", "");
        ...
        <tfoot>
          ...
          <?php if ($status == 'T') { ?>
            <tr style="border-color: #c0c0c0; border-style: outset; border-width: 2px; margin-top: 30px;">
              ...
              <td style="padding-top: 30px;">
                <span class="text-danger" style="font-weight: bolder; ">Valor Abertura: <?php echo 'R$ ' . number_format($valor_abertura, 2, ",", "."); ?> </span>
              </td>

              <td style="padding-top: 30px;">
                <span class="text-danger" style="font-weight: bolder; ">Total Saídas: <?php echo 'R$ ' . number_format($valor_saida_soma, 2, ",", "."); ?> </span>
              </td>

              <td style="padding-top: 30px;">
                <span class="text-danger" style="font-weight: bolder; ">Total Entradas: <?php echo 'R$ ' . number_format($valor_entrada_soma, 2, ",", "."); ?> </span>
              </td>

              <td style="padding-top: 30px;">
                <span class="text-danger" style="font-weight: bolder; ">Total Geral: <?php echo 'R$ ' . number_format($valor_entrada_soma - $valor_saida_soma, 2, ",", "."); ?> </span>
              </td>
            </tr>
          <?php } ?>
